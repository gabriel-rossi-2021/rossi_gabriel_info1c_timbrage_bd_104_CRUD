...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            name_collaborateur_update = name_collaborateur_update.lower()

            valeur_update_dictionnaire = {"value_id_collaborateur": id_collaborateur_update, "value_name_collaborateur": name_collaborateur_update}
            print("valeur_update_dictionnaire ", valeur_update_dictionnaire)

            str_sql_update_nomcollaborateur = """UPDATE t_collaborateur SET nom_famille = %(value_name_collaborateur)s WHERE id_collaborateur = %(value_id_collaborateur)s"""
            with MaBaseDeDonnee() as mconn_bd:

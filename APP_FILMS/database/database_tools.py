"""
    ...
    Nécessite un fichier DUMP en MySql de la BD : /database/rossi_gabriel_info1c_timbrage_bd_104.sql
"""
import os
import re
...
class Toolsbd:
    ...
    def extract_name_bd_from_dump_file():
        """
            ...
            But : Extrait la chaîne de caractère du nom de la base de donnée contenu dans le fichier :
                    "rossi_gabriel_info1c_timbrage_bd_104.sql"
    ...
    def test_cmd_CRD_file_dump_sql():
        """
            ...
            Tester si il y a des problèmes éventuels sur le fichier : "rossi_gabriel_info1c_timbrage_bd_104.sql"
        ...
        try:
            if os.path.exists(NAME_FILE_DUMP_SQL_BD):
                ...
                lignes_fichier_dump = fichier_dump_sql_bd.read()
                """
                    Si le fichier DUMP en SQL "../database/rossi_gabriel_info1c_timbrage_bd_104.sql" existe, 
